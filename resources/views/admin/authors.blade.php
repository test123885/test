...
<br>
 <h1 style="color: #CC5B23">
    ...
    <span class="   ">&nbsp;&nbsp;&nbsp;&nbsp;count: 
        @if(!(App\Models\User::where('role','author')->get())->isEmpty())
        {{App\Models\User::where('role','author')->get()->count()}}
                    ...
                    scrollbar-width: thin ;
                     scrollbar-color: #4B5563 #E5E7EB;">
                            ...
                            <tr><td>{{$loop->iteration}}</td>
                                ...
                                <td><a href="/authorbooksforadmin/{{$item->id}}" title="show books"><i class="bi bi-eye-fill h4 text-success"></i></a></td>
