...
<div class=" " style="margin-left:10%;">
  <div class="row">
     ...
     @forelse ($data as $item)
         ...
         <div class="card mt-2 me-1 col-6  col-md-4 col-lg-3" style="height: 450px">
            <div class="row g-0">
              <div class="mt-2">
  ...
  <button type="button" class="btn     " data-bs-toggle="modal" data-bs-target="#exampleModaltwo" data-bs-whatever="{{$item->id}}" > <i class="bi bi-award h5"></i></button>
                 ...
                 <a href="/details/{{$item->id}}" title="show details"><i class="bi bi-eye-fill h4 text-success"></i></a>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form  action="/offer" method="POST" >
          @csrf
            <input type="hidden" class="form-control" id="recipient-bookone" name="book_id"  >
...
<script>
var exampleModal = document.getElementById('exampleModaltwo')
exampleModal.addEventListener('show.bs.modal', function (event) {
  ...
  var modalBodyInput = document.getElementById('recipient-bookone')
