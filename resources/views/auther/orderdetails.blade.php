...
>
    ...
    <div class="  ms-4 mt-4" >
<div class="row col-10" style="margin-left: 10%;margin-top: 50px">
            ...
            <div class="  text-start">
                ...
                <label for="recipient-name" class="col-form-label fw-bold ms-1 "> 
                    ...
                    Statuse  :   <span class="fw-light">
                        @foreach ($data as $item)
                        @if ($loop->first)
                        <input type="hidden" name="" id="booktypecheckout2" value="{{App\Models\Checkout::where('id',$item->checkout_id)->get()->value('booktype')}}">
